...
def measure():
    im_dir = '../PairLIE/PairLIE-our-results/SICE-test/I/*.JPG'#'results/LOL/I/*.png'改为'../PairLIE/PairLIE-our-results/LOL-test/I/'
    label_dir = '../PairLIE/PairLIE-testing-dataset/SICE-test/label/'#'../dataset/LIE/LOL-test/reference/'改为../PairLIE/PairLIE-testing-dataset/LOL-test/reference/
