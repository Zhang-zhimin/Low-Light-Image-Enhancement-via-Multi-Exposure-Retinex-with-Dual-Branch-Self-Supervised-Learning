...
parser.add_argument('--data_test', type=str, default='../PairLIE/PairLIE-testing-dataset/SICE-test/image')#这一行是自己加的，把上一行注释掉
...
parser.add_argument('--output_folder', type=str, default='../PairLIE/PairLIE-our-results/SICE-test/')#这一行是自己加的，把上一行注释掉
